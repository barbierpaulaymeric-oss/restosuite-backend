...
const API = {
  ...
  getHACCPHazards() {
    return this.request("/haccp-plan/hazards");
  },
  createHACCPHazard(data) {
    return this.request("/haccp-plan/hazards", { method: "POST", body: data });
  },
  updateHACCPHazard(id, data) {
    return this.request(`/haccp-plan/hazards/${id}`, { method: "PUT", body: data });
  },
  deleteHACCPHazard(id) {
    return this.request(`/haccp-plan/hazards/${id}`, { method: "DELETE" });
  },
  getHACCPCCPs() {
    return this.request("/haccp-plan/ccps");
  },
  saveHACCPCCP(data) {
    return this.request("/haccp-plan/ccps", { method: "POST", body: data });
  },
  deleteHACCPCCP(id) {
    return this.request(`/haccp-plan/ccps/${id}`, { method: "DELETE" });
  },
  getHACCPDecisionTree(hazardId) {
    return this.request(`/haccp-plan/decision-tree/${hazardId}`);
  },
  saveHACCPDecisionTree(hazardId, data) {
    return this.request(`/haccp-plan/decision-tree/${hazardId}`, { method: "POST", body: data });
  },
  getHACCPPlanSummary() {
...
function riskLabel(score) {
  if (score > 15) return "\xC9LEV\xC9";
  if (score >= 6) return "MOD\xC9R\xC9";
  return "FAIBLE";
}
...
function renderHACCPPlanShell() {
  ...
  app.innerHTML = `
    <div class="haccp-page">
      <div class="page-header">
        <h1><i data-lucide="shield-check" style="width:20px;height:20px;vertical-align:middle;margin-right:6px"></i>Plan HACCP formalis\xE9</h1>
      ...
      <div style="display:flex;gap:4px;margin-bottom:var(--space-4);border-bottom:2px solid var(--border-light)">
        ...
        <button class="haccp-plan-tab" data-tab="decision" style="padding:8px 16px;border:none;background:none;cursor:pointer;font-weight:600;color:var(--text-secondary);border-bottom:2px solid transparent;margin-bottom:-2px">Arbre de d\xE9cision</button>
        <button class="haccp-plan-tab" data-tab="ccps"     style="padding:8px 16px;border:none;background:none;cursor:pointer;font-weight:600;color:var(--text-secondary);border-bottom:2px solid transparent;margin-bottom:-2px">Tableau de ma\xEEtrise</button>
        <button class="haccp-plan-tab" data-tab="summary"  style="padding:8px 16px;border:none;background:none;cursor:pointer;font-weight:600;color:var(--text-secondary);border-bottom:2px solid transparent;margin-bottom:-2px">Synth\xE8se</button>
      </div>
...
function activateHACCPPlanTab(tab) {
  ...
  switch (tab) {
    case "hazards":
      renderHazardsTab(content);
      break;
    case "decision":
      renderDecisionTab(content);
      break;
    case "ccps":
      renderCCPsTab(content);
      break;
    case "summary":
...
function renderHazardsTab(container) {
  ...
  if (!hazards.length) {
    container.innerHTML = `<div class="empty-state"><i data-lucide="shield-off" style="width:40px;height:40px;margin-bottom:12px;opacity:.4"></i><p>Aucun danger identifi\xE9.</p><button class="btn btn-primary" onclick="openHazardModal(null)">Ajouter un danger</button></div>`;
    if (window.lucide) lucide.createIcons();
    return;
  }
  const byStep = {};
  ...
  container.innerHTML = `
      ...
      <table style="width:100%;border-collapse:collapse;font-size:14px">
        <thead>
          <tr style="background:var(--bg-secondary);text-align:left">
            <th style="padding:10px 12px;border-bottom:2px solid var(--border-light)">\xC9tape</th>
            <th style="padding:10px 12px;border-bottom:2px solid var(--border-light)">Type</th>
            <th style="padding:10px 12px;border-bottom:2px solid var(--border-light);min-width:200px">Danger identifi\xE9</th>
            ...
            <th style="padding:10px 12px;border-bottom:2px solid var(--border-light);min-width:200px">Mesures pr\xE9ventives</th>
    ...
    return `
              ...
              <tr class="haccp-hazard-row" data-id="${h.id}" style="border-bottom:1px solid var(--border-light)">
                ...
                <td style="padding:10px 12px;white-space:nowrap">
                  ...
                  <button class="btn btn-ghost btn-sm btn-delete-hazard" data-id="${h.id}" title="Supprimer">\u{1F5D1}\uFE0F</button>
                </td>
              </tr>
            `;
  }).join("")}
    ...
    <p style="margin-top:12px;font-size:12px;color:var(--text-secondary)">G = Gravit\xE9 (1\u20135) &nbsp;\xB7&nbsp; P = Probabilit\xE9 (1\u20135) &nbsp;\xB7&nbsp; Score = G \xD7 P &nbsp;\xB7&nbsp; Vert &lt;6 / Orange 6\u201315 / Rouge &gt;15</p>
  `;
  ...
  container.querySelectorAll(".btn-delete-hazard").forEach((btn) => {
    btn.addEventListener("click", async () => {
      ...
      try {
        ...
        showToast("Danger supprim\xE9", "success");
      } catch (e) {
        showToast("Erreur : " + e.message, "error");
      }
    });
...
function openHazardModal(hazard) {
  ...
  modal.querySelector(".btn-modal-save").addEventListener("click", async () => {
    ...
    if (!step || !desc) {
      showToast("\xC9tape et description requis", "error");
      return;
    }
    const data = {
      step_name: step,
    ...
    try {
      ...
      showToast(isEdit ? "Danger mis \xE0 jour" : "Danger ajout\xE9", "success");
    } catch (e) {
      showToast("Erreur : " + e.message, "error");
    }
  });
...
async function renderDecisionTab(container) {
  ...
  container.innerHTML = `
    <div style="margin-bottom:16px;padding:12px 16px;background:var(--bg-secondary);border-radius:8px;font-size:13px;line-height:1.6">
      <strong>Arbre de d\xE9cision Codex Alimentarius (CAC/RCP 1-1969) :</strong><br>
      <strong>Q1</strong> Des mesures pr\xE9ventives existent-elles ? &nbsp;\xB7&nbsp;
      <strong>Q2</strong> L'\xE9tape est-elle con\xE7ue pour \xE9liminer/r\xE9duire le danger ? &nbsp;\xB7&nbsp;
      <strong>Q3</strong> Une contamination peut-elle survenir ? &nbsp;\xB7&nbsp;
      <strong>Q4</strong> Une \xE9tape ult\xE9rieure \xE9limine-t-elle le danger ?
    </div>
    ...
    return `
      ...
      return `
              ...
              <div style="display:flex;flex-direction:column;align-items:center;gap:6px;min-width:80px">
                <span style="font-size:11px;color:var(--text-secondary);text-transform:uppercase;letter-spacing:.05em">R\xE9sultat</span>
  ...
  container.querySelectorAll(".dt-save-btn").forEach((btn) => {
    btn.addEventListener("click", async () => {
      ...
      if (vals.some((v) => v === "")) {
        showToast("R\xE9pondez \xE0 toutes les questions", "error");
        return;
      }
      ...
      try {
        ...
        _haccpPlanData = await loadHACCPPlanData();
        showToast(`R\xE9sultat : ${result.result}`, "success");
      } catch (e) {
        showToast("Erreur : " + e.message, "error");
      }
    });
  ...
  if (!ccpHazards.length) {
    container.innerHTML = `
      <div class="empty-state">
        ...
        <p>Aucun CCP identifi\xE9. Utilisez l'arbre de d\xE9cision pour qualifier vos dangers.</p>
      </div>
    `;
    if (window.lucide) lucide.createIcons();
    return;
  ...
  container.querySelectorAll(".btn-save-ccp").forEach((btn) => {
    btn.addEventListener("click", async () => {
      ...
      try {
        ...
        _haccpPlanData = await loadHACCPPlanData();
        showToast("CCP enregistr\xE9", "success");
      } catch (e) {
        showToast("Erreur : " + e.message, "error");
      }
    });
    ...
    container.innerHTML = `
      ...
      <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:12px;margin-bottom:24px">
        <div class="card" style="text-align:center;padding:16px">
          ...
          <div style="font-size:12px;color:var(--text-secondary);margin-top:4px">Dangers identifi\xE9s</div>
        </div>
        <div class="card" style="text-align:center;padding:16px">
        ...
        <div class="card" style="text-align:center;padding:16px">
          ...
          <div style="font-size:12px;color:var(--text-secondary);margin-top:4px">Risque \xE9lev\xE9</div>
        </div>
      </div>

      <!-- Tableau r\xE9capitulatif -->
      <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;flex-wrap:wrap;gap:8px">
        <h3 style="margin:0;font-size:16px">Tableau r\xE9capitulatif des mesures de ma\xEEtrise</h3>
        <button class="btn btn-secondary btn-sm" onclick="window.print()" title="Imprimer ce tableau">\u{1F5A8}\uFE0F Imprimer</button>
      </div>
      <div style="overflow-x:auto">
        <table style="width:100%;border-collapse:collapse;font-size:13px" id="haccp-summary-table">
          <thead>
            <tr style="background:var(--bg-secondary)">
              <th style="padding:10px 12px;border:1px solid var(--border-light);text-align:left">\xC9tape</th>
      ...
      <p style="margin-top:12px;font-size:12px;color:var(--text-secondary)">Document g\xE9n\xE9r\xE9 par RestoSuite \u2014 Conforme Codex Alimentarius CAC/RCP 1-1969 \xB7 ${(/* @__PURE__ */ new Date()).toLocaleDateString("fr-FR")}</p>
    `;
  } catch (e) {
...
const CA_STATUS_LABELS = {
  en_cours: "En cours",
  "termin\xE9": "Termin\xE9",
  "escalad\xE9": "Escalad\xE9"
};
const CA_STATUS_COLORS = {
  en_cours: "var(--color-warning)",
  "termin\xE9": "var(--color-success)",
  "escalad\xE9": "var(--color-danger)"
};
...
async function renderCorrectiveActions() {
  ...
  try {
    let renderView2 = function() {
        ...
        <div class="haccp-page">
          ...
          <div class="tabs" style="display:flex;gap:4px;margin-bottom:20px;border-bottom:2px solid var(--color-border)">
            ...
            <button class="tab-btn ${activeTab === "templates" ? "tab-btn--active" : ""}" data-tab="templates" style="padding:8px 18px;background:none;border:none;cursor:pointer;font-weight:${activeTab === "templates" ? "700" : "400"};color:${activeTab === "templates" ? "var(--color-accent)" : "var(--color-text-muted)"};border-bottom:2px solid ${activeTab === "templates" ? "var(--color-accent)" : "transparent"};margin-bottom:-2px">
              <i data-lucide="library" style="width:16px;height:16px;vertical-align:middle;margin-right:6px"></i>Mod\xE8les d'actions
            </button>
          </div>
      ...
      renderTabContent2();
      setupTabEvents2();
      setupNewActionButton2();
    }, renderTabContent2 = function() {
      const container = document.getElementById("ca-tab-content");
      if (activeTab === "log") {
        renderLogTab2(container);
      } else {
        renderTemplatesTab2(container);
      }
    }, renderLogTab2 = function(container) {
      var _a, _b;
      const catFilter = container ? container.dataset.catFilter || "" : "";
      const statusFilter = container ? container.dataset.statusFilter || "" : "";
      let filtered2 = logItems;
      if (catFilter) filtered2 = filtered2.filter((i) => i.category === catFilter);
      if (statusFilter) filtered2 = filtered2.filter((i) => i.status === statusFilter);
      const catOptions = ["", ...Object.keys(CA_CATEGORY_LABELS)].map(
        (c) => `<option value="${c}" ${catFilter === c ? "selected" : ""}>${c ? CA_CATEGORY_LABELS[c] : "Toutes cat\xE9gories"}</option>`
      ).join("");
      const statusOptions = ["", "en_cours", "termin\xE9", "escalad\xE9"].map(
        (s) => `<option value="${s}" ${statusFilter === s ? "selected" : ""}>${s ? CA_STATUS_LABELS[s] : "Tous statuts"}</option>`
      ).join("");
      container.innerHTML = `
        ...
        ${filtered2.length === 0 ? `
          <div class="empty-state">
            <i data-lucide="check-circle-2" style="width:40px;height:40px;color:var(--color-success);margin-bottom:8px"></i>
            <p>Aucune action corrective enregistr\xE9e</p>
          </div>
        ` : `
          <div class="table-container">
            <table>
      ...
      `;
      if (window.lucide) lucide.createIcons({ nodes: [container] });
      (_a = document.getElementById("ca-filter-cat")) == null ? void 0 : _a.addEventListener("change", (e) => {
        container.dataset.catFilter = e.target.value;
        renderLogTab2(container);
      });
      (_b = document.getElementById("ca-filter-status")) == null ? void 0 : _b.addEventListener("change", (e) => {
      ...
      container.querySelectorAll(".ca-log-row").forEach((row) => {
        row.addEventListener("click", (e) => {
          ...
          if (item) showEditLogModal2(item);
        });
      });
        ...
        btn.addEventListener("click", async (e) => {
          ...
          try {
            await API.request(`/corrective-actions/log/${id}`, {
              method: "PUT",
              body: { status: "termin\xE9", completed_at: (/* @__PURE__ */ new Date()).toISOString() }
            });
            await refreshData();
          } catch (err) {
    ...
    }, renderTemplatesTab2 = function(container) {
      var _a;
      const grouped = {};
      templates.forEach((t) => {
      ...
      container.innerHTML = `
        <div style="display:flex;justify-content:flex-end;margin-bottom:16px">
          <button class="btn btn-primary" id="btn-new-template">
            <i data-lucide="plus" style="width:16px;height:16px"></i> Nouveau mod\xE8le
          </button>
        </div>
        ...
        return `
            <div style="margin-bottom:20px">
              <h3 style="display:flex;align-items:center;gap:8px;margin-bottom:10px;color:${CA_CATEGORY_COLORS[cat]}">
                ...
                <span style="font-size:0.75rem;font-weight:400;color:var(--color-text-muted)">${items.length} mod\xE8le${items.length > 1 ? "s" : ""}</span>
              </h3>
                  ...
                  <div class="card" style="padding:12px 16px;display:grid;grid-template-columns:1fr auto;gap:8px;align-items:start">
                    <div>
                      ...
                      <div style="display:flex;gap:12px;font-size:0.78rem;color:var(--color-text-muted)">
                        ${t.deadline_hours != null ? `<span><i data-lucide="clock" style="width:12px;height:12px;vertical-align:middle"></i> ${t.deadline_hours === 0 ? "Imm\xE9diat" : t.deadline_hours + "h max"}</span>` : ""}
                    ...
                    <div style="display:flex;gap:6px;flex-shrink:0">
                      ...
                      <button class="btn btn-sm btn-outline ca-toggle-tpl-btn" data-id="${t.id}" data-active="${t.is_active}" title="${t.is_active ? "D\xE9sactiver" : "Activer"}">
        ...
        ${templates.length === 0 ? `
          <div class="empty-state">
            ...
            <p>Aucun mod\xE8le d'action corrective</p>
          </div>
        ` : ""}
      `;
      if (window.lucide) lucide.createIcons({ nodes: [container] });
      (_a = document.getElementById("btn-new-template")) == null ? void 0 : _a.addEventListener("click", () => showTemplateModal2());
      container.querySelectorAll(".ca-edit-tpl-btn").forEach((btn) => {
        btn.addEventListener("click", () => {
          const id = parseInt(btn.dataset.id, 10);
          const tpl = templates.find((t) => t.id === id);
          if (tpl) showTemplateModal2(tpl);
        });
      });
    ...
    }, setupNewActionButton2 = function() {
      var _a;
      (_a = document.getElementById("btn-new-ca")) == null ? void 0 : _a.addEventListener("click", () => showNewLogModal2());
    }, showNewLogModal2 = function() {
      const tplOptions = templates.map(
        (t) => `<option value="${t.id}" data-category="${t.category}" data-trigger="${escapeHtml(t.trigger_condition || "")}" data-action="${escapeHtml(t.action_description || "")}">${CA_CATEGORY_LABELS[t.category] || t.category} \u2014 ${escapeHtml(t.trigger_condition || "Sans titre")}</option>`
      ).join("");
      const catOptions = Object.entries(CA_CATEGORY_LABELS).map(
      ...
      document.getElementById("ca-modal-save").addEventListener("click", async () => {
        ...
        if (!category) {
          showToast("Cat\xE9gorie requise", "error");
          return;
        }
        ...
        try {
          ...
          overlay.remove();
          showToast("Action corrective enregistr\xE9e", "success");
          await refreshData();
        } catch (err) {
          showToast("Erreur lors de l'enregistrement", "error");
        }
      });
    }, showEditLogModal2 = function(item) {
      const statusOptions = ["en_cours", "termin\xE9", "escalad\xE9"].map(
        (s) => `<option value="${s}" ${item.status === s ? "selected" : ""}>${CA_STATUS_LABELS[s]}</option>`
      ).join("");
      const overlay = document.createElement("div");
      overlay.className = "modal-overlay";
      overlay.innerHTML = `
      ...
      document.getElementById("ca-edit-save").addEventListener("click", async () => {
        ...
        try {
          ...
          overlay.remove();
          showToast("Action mise \xE0 jour", "success");
          await refreshData();
        } catch (err) {
          showToast("Erreur lors de la mise \xE0 jour", "error");
        }
      });
    }, showTemplateModal2 = function(tpl = null) {
      const catOptions = Object.entries(CA_CATEGORY_LABELS).map(
        ([v, l]) => `<option value="${v}" ${tpl && tpl.category === v ? "selected" : ""}>${l}</option>`
      ).join("");
      const overlay = document.createElement("div");
      overlay.className = "modal-overlay";
      overlay.innerHTML = `
        <div class="modal" style="max-width:540px">
          <div class="modal-header">
            <h2><i data-lucide="library" style="width:20px;height:20px;vertical-align:middle;margin-right:8px"></i>${tpl ? "Modifier le mod\xE8le" : "Nouveau mod\xE8le"}</h2>
      ...
      document.getElementById("ca-tpl-save").addEventListener("click", async () => {
        ...
        try {
          ...
          overlay.remove();
          showToast(tpl ? "Mod\xE8le mis \xE0 jour" : "Mod\xE8le cr\xE9\xE9", "success");
          await refreshData();
        } catch (err) {
          showToast("Erreur lors de l'enregistrement", "error");
        }
    ...
    var renderView = renderView2, renderTabContent = renderTabContent2, renderLogTab = renderLogTab2, renderTemplatesTab = renderTemplatesTab2, setupTabEvents = setupTabEvents2, setupNewActionButton = setupNewActionButton2, showNewLogModal = showNewLogModal2, showEditLogModal = showEditLogModal2, showTemplateModal = showTemplateModal2;
    ...
    async function refreshData() {
      ...
      logItems.length = 0;
      logItems.push(...logResp2.items || []);
      Object.assign(stats, statsResp2 || {});
      templates.length = 0;
      templates.push(...tplResp2.items || []);
      renderView2();
    }
    renderView2();
  } catch (e) {
...
function tdFmtDate(d) {
  if (!d) return "\u2014";
  try {
    return (/* @__PURE__ */ new Date(d + "T00:00:00")).toLocaleDateString("fr-FR", { day: "2-digit", month: "2-digit", year: "numeric" });
  } catch (e) {
    return d;
  }
}
function tdFmtTemp(t) {
  ...
  return `<span style="font-weight:600;color:${color}">${v.toFixed(1)}\xB0C</span>`;
}
...
function renderTDRows(items) {
  if (!items.length) {
    return `<tr><td colspan="8" style="text-align:center;color:var(--color-text-muted);padding:32px">
      <i data-lucide="package-x" style="width:32px;height:32px;margin-bottom:8px;opacity:0.4"></i><br>Aucune exp\xE9dition trouv\xE9e
    </td></tr>`;
  }
  return items.map((r) => `
    <tr data-id="${r.id}" style="cursor:pointer" class="td-row">
      ...
      <td>
        ${r.batch_number ? `<code style="font-size:0.8rem;background:var(--color-bg-secondary);padding:2px 6px;border-radius:4px">${escapeHtml(r.batch_number)}</code>` : '<span style="color:var(--color-text-muted)">\u2014</span>'}
      </td>
      <td>
  ...
  return `
    <div class="modal-overlay active" id="td-modal">
      <div class="modal" style="max-width:580px;width:95vw">
        <div class="modal-header">
          <h3><i data-lucide="${isEdit ? "pencil" : "plus-circle"}" style="width:18px;height:18px;vertical-align:middle;margin-right:6px"></i>${isEdit ? "Modifier l'exp\xE9dition" : "Nouvelle exp\xE9dition"}</h3>
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:var(--space-3)">
            ...
            <div class="form-group">
              ...
              <select class="form-control" id="td-unit">
                ...
                <option value="pi\xE8ce" ${v.unit === "pi\xE8ce" ? "selected" : ""}>pi\xE8ce(s)</option>
...
async function renderTraceabilityDownstream() {
  ...
  function renderPage(items, highlightBatch) {
    ...
    app.innerHTML = `
      <div class="haccp-page">
        <div class="page-header">
          <h1><i data-lucide="package-check" style="width:22px;height:22px;vertical-align:middle;margin-right:8px;color:var(--color-primary)"></i>Tra\xE7abilit\xE9 aval</h1>
          <button class="btn btn-primary" id="td-btn-new">
            <i data-lucide="plus" style="width:18px;height:18px"></i> Nouvelle exp\xE9dition
          </button>
        </div>
        ...
        <div class="kpi-grid" style="grid-template-columns:repeat(auto-fit,minmax(160px,1fr));margin-bottom:var(--space-5)">
          <div class="kpi-card">
            ...
            <div class="kpi-label">Exp\xE9ditions ce mois</div>
          </div>
        ...
        <div style="background:var(--color-bg-secondary);border:1px solid var(--color-border);border-radius:var(--radius-2);padding:var(--space-4);margin-bottom:var(--space-4)">
          ...
          ${highlightBatch ? `<p style="margin-top:var(--space-2);color:var(--color-primary);font-size:0.85rem">
            ...
            ${items.length} r\xE9sultat(s) pour le lot <strong>"${escapeHtml(highlightBatch)}"</strong>
          </p>` : ""}
        </div>
        ...
        <div style="display:flex;flex-wrap:wrap;gap:var(--space-3);margin-bottom:var(--space-4);align-items:flex-end">
          ...
          <button class="btn btn-secondary" id="td-filter-reset" style="align-self:flex-end">
            <i data-lucide="rotate-ccw" style="width:15px;height:15px"></i> R\xE9initialiser
          </button>
        </div>
  ...
  async function confirmDelete(id) {
    ...
    if (!confirm(`Supprimer l'exp\xE9dition "${name}" ?
...
function renderPMSShell() {
  ...
  app.innerHTML = `
    <div class="pms-export-page">
      ...
      <!-- \u2500\u2500 Barre d'outils (masqu\xE9e \xE0 l'impression) \u2500\u2500 -->
      <div class="pms-toolbar no-print">
        <div class="pms-toolbar__left">
          ...
          <span class="pms-toolbar__subtitle">Plan de Ma\xEEtrise Sanitaire complet</span>
        </div>
      ...
      <div class="pms-document" id="pms-document">
        ...
        <div class="pms-cover print-page-break-after">
          ...
          <div class="pms-cover__title">Plan de Ma\xEEtrise Sanitaire</div>
          <div class="pms-cover__subtitle">Document officiel \u2014 Contr\xF4le DDPP</div>
          ...
          <table class="pms-cover__info-table">
            ...
            <tr><td>T\xE9l\xE9phone</td><td>${escapeHtml(r.phone || "\u2014")}</td></tr>
            ...
            <tr><td>N\xB0 agr\xE9ment sanitaire</td><td>${escapeHtml(d.sanitary_settings.sanitary_approval_number)}</td></tr>
            <tr><td>Type d'agr\xE9ment</td><td>${escapeHtml(d.sanitary_settings.sanitary_approval_type || "\u2014")}</td></tr>
            ` : ""}
            <tr><td>Date de g\xE9n\xE9ration</td><td>${dateStr}</td></tr>
            <tr><td>P\xE9riode des donn\xE9es</td><td>${((_a = periodOptions.find((o) => o.value === d.period)) == null ? void 0 : _a.label) || d.period}</td></tr>
          </table>
        ...
        <div class="pms-toc print-page-break-after no-print">
          <h2 class="pms-section-title">Table des mati\xE8res</h2>
          <ol class="pms-toc__list">
            <li><a href="#pms-s1">Informations g\xE9n\xE9rales & param\xE8tres sanitaires</a></li>
            <li><a href="#pms-s2">Analyse des dangers (HACCP)</a></li>
            <li><a href="#pms-s3">Points Critiques de Contr\xF4le (CCP)</a></li>
            <li><a href="#pms-s4">Arbre de d\xE9cision</a></li>
            <li><a href="#pms-s5">Plan de nettoyage & d\xE9sinfection</a></li>
            <li><a href="#pms-s6">Relev\xE9s de temp\xE9rature</a></li>
            <li><a href="#pms-s7">Tra\xE7abilit\xE9 (amont & aval)</a></li>
            <li><a href="#pms-s8">Formation du personnel</a></li>
            <li><a href="#pms-s9">Lutte contre les nuisibles</a></li>
            <li><a href="#pms-s10">Maintenance des \xE9quipements</a></li>
            <li><a href="#pms-s11">Gestion des d\xE9chets</a></li>
            <li><a href="#pms-s12">Gestion des allerg\xE8nes (INCO)</a></li>
            <li><a href="#pms-s13">Proc\xE9dures de retrait & rappel</a></li>
        ...
        <!-- \u2550\u2550 Section 1 \u2014 Informations g\xE9n\xE9rales \u2550\u2550 -->
        ${renderPMSSection1(d)}
        ...
        <!-- \u2550\u2550 Section 4 \u2014 Arbre de d\xE9cision \u2550\u2550 -->
        ${renderPMSSection4(d)}

        <!-- \u2550\u2550 Section 5 \u2014 Nettoyage \u2550\u2550 -->
        ${renderPMSSection5(d)}

        <!-- \u2550\u2550 Section 6 \u2014 Temp\xE9ratures \u2550\u2550 -->
        ${renderPMSSection6(d)}

        <!-- \u2550\u2550 Section 7 \u2014 Tra\xE7abilit\xE9 \u2550\u2550 -->
        ${renderPMSSection7(d)}
        ...
        <!-- \u2550\u2550 Section 11 \u2014 D\xE9chets \u2550\u2550 -->
        ${renderPMSSection11(d)}

        <!-- \u2550\u2550 Section 12 \u2014 Allerg\xE8nes \u2550\u2550 -->
        ...
        <div class="pms-footer-doc">
          <p>Document g\xE9n\xE9r\xE9 le ${dateStr} via RestoSuite \u2014 Plan de Ma\xEEtrise Sanitaire de ${escapeHtml(r.name || "l'\xE9tablissement")}</p>
          <p>Ce document est confidentiel et destin\xE9 exclusivement aux autorit\xE9s sanitaires comp\xE9tentes.</p>
        </div>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s1">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Informations g\xE9n\xE9rales & param\xE8tres sanitaires</h2>
      </div>
        ...
        <div class="pms-info-grid">
          <div class="pms-info-card">
            ...
            <table class="pms-table pms-table--compact">
              ...
              <tr><th>T\xE9l\xE9phone</th><td>${escapeHtml(r.phone || "\u2014")}</td></tr>
...
function renderPMSSection2(d) {
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s2">
      ...
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi"><span class="pms-kpi__val">${total}</span><span class="pms-kpi__lbl">Dangers identifi\xE9s</span></div>
          <div class="pms-kpi pms-kpi--danger"><span class="pms-kpi__val">${ccp_count}</span><span class="pms-kpi__lbl">CCP</span></div>
          <div class="pms-kpi pms-kpi--warning"><span class="pms-kpi__val">${high_risk}</span><span class="pms-kpi__lbl">Risque \xE9lev\xE9</span></div>
        ...
        ${total === 0 ? '<p class="pms-empty">Aucune analyse des dangers enregistr\xE9e.</p>' : ""}
        ${Object.entries(byStep).map(([step, hazards]) => `
          <h3 class="pms-subsection-title">\xC9tape : ${escapeHtml(step)}</h3>
          <table class="pms-table">
            <thead>
              <tr>
                <th>Type</th>
                <th>Danger identifi\xE9</th>
                <th style="text-align:center">Gravit\xE9</th>
                <th style="text-align:center">Probabilit\xE9</th>
    ...
    const scoreBadge = score > 15 ? `<span class="pms-badge pms-badge--danger">${score}</span>` : score >= 6 ? `<span class="pms-badge pms-badge--warning">${score}</span>` : `<span class="pms-badge pms-badge--ok">${score}</span>`;
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s3">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Points Critiques de Contr\xF4le (CCP)</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi pms-kpi--danger"><span class="pms-kpi__val">${total}</span><span class="pms-kpi__lbl">CCP d\xE9finis</span></div>
        </div>
        ${total === 0 ? '<p class="pms-empty">Aucun CCP enregistr\xE9.</p>' : `
        <table class="pms-table">
          <thead>
            <tr>
              <th>N\xB0 CCP</th>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s4">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Arbre de d\xE9cision HACCP</h2>
      </div>
      <div class="pms-section__body">
        ${total === 0 ? `<p class="pms-empty">Aucun r\xE9sultat d'arbre de d\xE9cision enregistr\xE9.</p>` : `
        <table class="pms-table">
          <thead>
            <tr>
              <th>\xC9tape</th>
              <th>Danger</th>
              <th style="text-align:center">Q1 \u2014 Mesure pr\xE9ventive ?</th>
              <th style="text-align:center">Q2 \u2014 \xC9tape \xE9limine ?</th>
              <th style="text-align:center">Q3 \u2014 Contamination possible ?</th>
              <th style="text-align:center">Q4 \u2014 \xC9tape suivante \xE9limine ?</th>
              <th style="text-align:center">R\xE9sultat</th>
            </tr>
          </thead>
          <tbody>
            ${items.map((row) => `<tr>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s5">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Plan de nettoyage & d\xE9sinfection</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi"><span class="pms-kpi__val">${stats.total}</span><span class="pms-kpi__lbl">T\xE2ches totales</span></div>
          ...
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${recent_logs.length}</span><span class="pms-kpi__lbl">R\xE9alisations (p\xE9riode)</span></div>
        </div>
        ${tasks.length === 0 ? '<p class="pms-empty">Aucune t\xE2che de nettoyage enregistr\xE9e.</p>' : ""}
        ${Object.entries(byZone).map(([zone, zoneTasks]) => `
          <h3 class="pms-subsection-title">Zone : ${escapeHtml(zone)}</h3>
          <table class="pms-table">
            <thead><tr><th>T\xE2che</th><th>Fr\xE9quence</th><th>Produit</th><th>M\xE9thode / Protocole</th></tr></thead>
            <tbody>
              ${zoneTasks.map((t) => `<tr>
        ...
        ${recent_logs.length > 0 ? `
          <h3 class="pms-subsection-title">Registre des r\xE9alisations (extrait \u2014 ${recent_logs.length} entr\xE9es)</h3>
          <table class="pms-table">
            <thead><tr><th>Date</th><th>T\xE2che</th><th>Zone</th><th>R\xE9alis\xE9 par</th><th>Notes</th></tr></thead>
            <tbody>
              ...
              ${recent_logs.length > 30 ? `<tr><td colspan="5" style="text-align:center;font-style:italic;color:var(--text-secondary)">... et ${recent_logs.length - 30} entr\xE9e(s) suppl\xE9mentaire(s) non affich\xE9es</td></tr>` : ""}
            </tbody>
          </table>
        ` : ""}
      </div>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s6">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Relev\xE9s de temp\xE9rature</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi"><span class="pms-kpi__val">${zones.length}</span><span class="pms-kpi__lbl">Zones surveill\xE9es</span></div>
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${logs.length}</span><span class="pms-kpi__lbl">Relev\xE9s (p\xE9riode)</span></div>
          ...
          <div class="pms-kpi"><span class="pms-kpi__val">${reheating_logs.length}</span><span class="pms-kpi__lbl">Remises en T\xB0</span></div>
        </div>

        <h3 class="pms-subsection-title">Zones de surveillance</h3>
        <table class="pms-table">
          <thead><tr><th>Zone</th><th>Type</th><th>Plage autoris\xE9e</th></tr></thead>
          <tbody>
            ${zones.map((z) => `<tr>
              <td>${escapeHtml(z.name)}</td>
              <td>${escapeHtml(z.type)}</td>
              <td>${z.min_temp}\xB0C \u2192 ${z.max_temp}\xB0C</td>
            </tr>`).join("")}
          </tbody>
        </table>

        ${alert_count > 0 ? `
          <h3 class="pms-subsection-title pms-subsection-title--danger">\u26A0 Alertes de temp\xE9rature (p\xE9riode)</h3>
          <table class="pms-table">
            <thead><tr><th>Date/Heure</th><th>Zone</th><th>Temp\xE9rature mesur\xE9e</th><th>Plage autoris\xE9e</th><th>Notes</th></tr></thead>
            <tbody>
              ${logs.filter((l) => l.is_alert).map((l) => `<tr class="pms-row--danger">
                ...
                <td><strong>${l.temperature}\xB0C</strong></td>
                <td>${l.min_temp}\xB0C \u2192 ${l.max_temp}\xB0C</td>
                <td>${escapeHtml(l.notes || "")}</td>
              </tr>`).join("")}
            </tbody>
          </table>
        ...
        ${logs.length > 0 ? `
          <h3 class="pms-subsection-title">Extrait des relev\xE9s (${Math.min(logs.length, 30)} sur ${logs.length})</h3>
          <table class="pms-table">
            <thead><tr><th>Date/Heure</th><th>Zone</th><th>Temp\xE9rature</th><th>Statut</th><th>Par</th></tr></thead>
            <tbody>
              ${logs.slice(0, 30).map((l) => `<tr class="${l.is_alert ? "pms-row--danger" : ""}">
                <td style="white-space:nowrap">${fmtDateTime(l.recorded_at)}</td>
                <td>${escapeHtml(l.zone_name)}</td>
                <td>${l.temperature}\xB0C</td>
        ...
        ` : '<p class="pms-empty">Aucun relev\xE9 sur la p\xE9riode.</p>'}

        ${cooling_logs.length > 0 ? `
          <h3 class="pms-subsection-title">Refroidissements rapides (${cooling_logs.length})</h3>
          <table class="pms-table">
            <thead><tr><th>Produit</th><th>D\xE9but</th><th>T\xB0 initiale</th><th>T\xB0 \xE0 63\xB0C \xE0</th><th>T\xB0 \xE0 10\xB0C \xE0</th><th>Conforme</th></tr></thead>
            <tbody>
        ...
        ${reheating_logs.length > 0 ? `
          <h3 class="pms-subsection-title">Remises en temp\xE9rature (${reheating_logs.length})</h3>
          <table class="pms-table">
            <thead><tr><th>Produit</th><th>D\xE9but</th><th>T\xB0 initiale</th><th>T\xB0 \xE0 63\xB0C \xE0</th><th>Conforme</th></tr></thead>
            <tbody>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s7">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Tra\xE7abilit\xE9 (amont & aval)</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${reception.length}</span><span class="pms-kpi__lbl">R\xE9ceptions</span></div>
        ...
        <h3 class="pms-subsection-title">Tra\xE7abilit\xE9 amont \u2014 R\xE9ceptions marchandises (${reception.length})</h3>
        ${reception.length === 0 ? '<p class="pms-empty">Aucune r\xE9ception sur la p\xE9riode.</p>' : `
        <table class="pms-table">
          <thead><tr><th>Date</th><th>Produit</th><th>Fournisseur</th><th>N\xB0 lot</th><th>DLC</th><th>T\xB0 r\xE9ception</th><th>Qt\xE9</th></tr></thead>
          <tbody>
            ${reception.slice(0, 40).map((r) => `<tr>
              ...
              <td>${r.temperature_at_reception != null ? `${r.temperature_at_reception}\xB0C` : "\u2014"}</td>
              <td>${r.quantity != null ? `${r.quantity} ${r.unit}` : "\u2014"}</td>
            </tr>`).join("")}
            ${reception.length > 40 ? `<tr><td colspan="7" style="text-align:center;font-style:italic">... ${reception.length - 40} entr\xE9es suppl\xE9mentaires</td></tr>` : ""}
          </tbody>
        </table>
        `}

        <h3 class="pms-subsection-title">Tra\xE7abilit\xE9 aval \u2014 Distribution & exp\xE9ditions (${downstream.length})</h3>
        ${downstream.length === 0 ? '<p class="pms-empty">Aucun dispatch sur la p\xE9riode.</p>' : `
        <table class="pms-table">
          ...
          <tbody>
            ${downstream.slice(0, 40).map((r) => `<tr>
              ...
              <td>${r.quantity != null ? `${r.quantity} ${r.unit}` : "\u2014"}</td>
              <td>${r.temperature_at_dispatch != null ? `${r.temperature_at_dispatch}\xB0C` : "\u2014"}</td>
              <td>${escapeHtml(r.responsible_person || "\u2014")}</td>
            </tr>`).join("")}
            ${downstream.length > 40 ? `<tr><td colspan="8" style="text-align:center;font-style:italic">... ${downstream.length - 40} entr\xE9es suppl\xE9mentaires</td></tr>` : ""}
          </tbody>
        </table>
        `}
      </div>
    ...
    <div class="pms-section print-page-break-before" id="pms-s8">
      ...
      <div class="pms-section__body">
        <div class="pms-kpis">
          ...
          <div class="pms-kpi pms-kpi--ok"><span class="pms-kpi__val">${stats.realise}</span><span class="pms-kpi__lbl">R\xE9alis\xE9es</span></div>
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${stats.planifie}</span><span class="pms-kpi__lbl">Planifi\xE9es</span></div>
          <div class="pms-kpi ${stats.expire > 0 ? "pms-kpi--danger" : "pms-kpi"}"><span class="pms-kpi__val">${stats.expire}</span><span class="pms-kpi__lbl">Expir\xE9es</span></div>
        </div>
        ${records.length === 0 ? '<p class="pms-empty">Aucune formation enregistr\xE9e.</p>' : `
        <table class="pms-table">
          <thead><tr><th>Employ\xE9</th><th>Formation</th><th>Formateur</th><th>Date</th><th>Dur\xE9e</th><th>Renouvellement</th><th>R\xE9f\xE9rence</th><th>Statut</th></tr></thead>
          <tbody>
            ${records.map((r) => `<tr class="${r.status === "expir\xE9" ? "pms-row--danger" : ""}">
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s9">
      ...
      <div class="pms-section__body">
        ...
        <table class="pms-table">
          <thead><tr><th>Date visite</th><th>Prestataire</th><th>N\xB0 contrat</th><th>Constatations</th><th>Actions prises</th><th>Postes app\xE2ts</th><th>Prochaine visite</th><th>Statut</th><th>Rapport</th></tr></thead>
          <tbody>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s10">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Maintenance des \xE9quipements</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi"><span class="pms-kpi__val">${stats.total}</span><span class="pms-kpi__lbl">\xC9quipements</span></div>
          <div class="pms-kpi pms-kpi--ok"><span class="pms-kpi__val">${stats.a_jour}</span><span class="pms-kpi__lbl">\xC0 jour</span></div>
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${stats.planifie}</span><span class="pms-kpi__lbl">Planifi\xE9s</span></div>
        ...
        ${items.length === 0 ? '<p class="pms-empty">Aucun \xE9quipement enregistr\xE9.</p>' : `
        <table class="pms-table">
          <thead><tr><th>\xC9quipement</th><th>Type</th><th>Localisation</th><th>Derni\xE8re maintenance</th><th>Prochaine maintenance</th><th>Type maintenance</th><th>Prestataire</th><th>Statut</th></tr></thead>
          <tbody>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s11">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Gestion des d\xE9chets</h2>
      </div>
      <div class="pms-section__body">
        ${items.length === 0 ? '<p class="pms-empty">Aucune fili\xE8re d\xE9chets enregistr\xE9e.</p>' : `
        <table class="pms-table">
          <thead><tr><th>Type de d\xE9chet</th><th>Prestataire</th><th>Fr\xE9quence de collecte</th><th>Derni\xE8re collecte</th><th>Prochaine collecte</th><th>N\xB0 contrat</th><th>Notes</th></tr></thead>
          <tbody>
            ${items.map((w) => `<tr>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s12">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Gestion des allerg\xE8nes \u2014 R\xE8glement INCO (UE 1169/2011)</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi"><span class="pms-kpi__val">${items.length}</span><span class="pms-kpi__lbl">Allerg\xE8nes recens\xE9s</span></div>
          <div class="pms-kpi pms-kpi--danger"><span class="pms-kpi__val">${items.filter((a) => a.risk_level === "\xE9lev\xE9").length}</span><span class="pms-kpi__lbl">Risque \xE9lev\xE9</span></div>
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${items.filter((a) => a.presence_in_menu).length}</span><span class="pms-kpi__lbl">Pr\xE9sents au menu</span></div>
        </div>
        ${items.length === 0 ? '<p class="pms-empty">Aucun plan allerg\xE8nes enregistr\xE9.</p>' : `
        <table class="pms-table">
          <thead>
            <tr>
              <th>Allerg\xE8ne</th>
              <th style="text-align:center">Pr\xE9sent au menu</th>
              <th style="text-align:center">Risque</th>
              <th>Risque contamination crois\xE9e</th>
              <th>Mesures pr\xE9ventives</th>
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s13">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Proc\xE9dures de retrait & rappel produits</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi"><span class="pms-kpi__val">${stats.total}</span><span class="pms-kpi__lbl">Proc\xE9dures totales</span></div>
          ...
          <div class="pms-kpi pms-kpi--ok"><span class="pms-kpi__val">${stats.cloture}</span><span class="pms-kpi__lbl">Cl\xF4tur\xE9es</span></div>
        </div>
        ${items.length === 0 ? '<p class="pms-empty">Aucune proc\xE9dure de retrait/rappel enregistr\xE9e.</p>' : `
        <table class="pms-table">
          <thead>
            <tr>
              <th>Date alerte</th>
              ...
              <th>Raison</th>
              <th>Source alerte</th>
              <th style="text-align:center">S\xE9v\xE9rit\xE9</th>
              <th>Qt\xE9 affect\xE9e</th>
              <th>Actions prises</th>
              <th>Notification envoy\xE9e</th>
              <th>Date cl\xF4ture</th>
...
function renderPMSSection14(d) {
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s14">
      ...
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi"><span class="pms-kpi__val">${templates.length}</span><span class="pms-kpi__lbl">Mod\xE8les actifs</span></div>
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${log.length}</span><span class="pms-kpi__lbl">Actions (p\xE9riode)</span></div>
          ...
          <div class="pms-kpi pms-kpi--ok"><span class="pms-kpi__val">${log.filter((a) => a.status === "termin\xE9").length}</span><span class="pms-kpi__lbl">Termin\xE9es</span></div>
        </div>

        <h3 class="pms-subsection-title">Mod\xE8les d'actions correctives (${templates.length})</h3>
        <table class="pms-table">
          <thead><tr><th>Cat\xE9gorie</th><th>D\xE9clencheur</th><th>Action \xE0 mener</th><th>Responsable</th><th>D\xE9lai</th><th>Documentation requise</th></tr></thead>
          <tbody>
            ${templates.map((t) => `<tr>
        ...
        ${log.length > 0 ? `
          <h3 class="pms-subsection-title">Registre des actions correctives (${log.length} sur la p\xE9riode)</h3>
          <table class="pms-table">
            <thead><tr><th>Date</th><th>Cat\xE9gorie</th><th>D\xE9clencheur</th><th>Action prise</th><th>Responsable</th><th>Statut</th></tr></thead>
            <tbody>
              ${log.slice(0, 30).map((a) => `<tr class="${a.status === "escalad\xE9" ? "pms-row--danger" : ""}">
        ...
        ` : '<p class="pms-empty">Aucune action corrective enregistr\xE9e sur la p\xE9riode.</p>'}
      </div>
    </div>
  `;
}
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s15">
      <div class="pms-section__header">
        ...
        <h2 class="pms-section__title">Fournisseurs agr\xE9\xE9s</h2>
      </div>
      <div class="pms-section__body">
        <div class="pms-kpis">
          <div class="pms-kpi pms-kpi--info"><span class="pms-kpi__val">${total}</span><span class="pms-kpi__lbl">Fournisseurs</span></div>
        </div>
        ${total === 0 ? '<p class="pms-empty">Aucun fournisseur enregistr\xE9.</p>' : `
        <table class="pms-table">
          <thead><tr><th>Nom fournisseur</th><th>Contact</th><th>T\xE9l\xE9phone</th><th>Email</th><th>Note qualit\xE9</th><th>Commentaire qualit\xE9</th></tr></thead>
          <tbody>
            ${items.map((s) => `<tr>
...
function renderPMSSection16(d) {
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s16">
      ...
      <div class="pms-section__body">
        ${items.length === 0 ? `<p class="pms-empty">Aucune analyse d'eau enregistr\xE9e.</p>` : `
        <table class="pms-table">
          <thead><tr><th>Date</th><th>Type analyse</th><th>Prestataire</th><th>Source</th><th>R\xE9sultats</th><th>Conformit\xE9</th><th>Prochaine analyse</th></tr></thead>
          <tbody>
...
function renderPMSSection17(d) {
  ...
  return `
    <div class="pms-section print-page-break-before" id="pms-s17">
      ...
      <div class="pms-section__body">
        ${items.length === 0 ? '<p class="pms-empty">Aucun audit PMS enregistr\xE9.</p>' : `
        ${items.map((a) => {
    let findings = [];
    try {
    ...
    return `
            <div class="pms-audit-card">
              ...
              ${findings.length > 0 ? `
                <table class="pms-table pms-table--compact">
                  <thead><tr><th>Section</th><th>Constatation</th><th>S\xE9v\xE9rit\xE9</th><th>Action requise</th></tr></thead>
                  <tbody>
                    ${findings.map((f) => `<tr>
...
function isDLCAlert(dlc) {
  if (!dlc) return false;
  return new Date(dlc) < /* @__PURE__ */ new Date();
}
const PMS_PRINT_CSS = `
  ...
  @media print {
    ...
    /* En-t\xEAte et pied de page sur chaque page */
